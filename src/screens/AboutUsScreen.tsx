			...
			<div className={styles.aboutUsScreen_processBox}>
				...
				<div>
					...
					<p className={styles.aboutUsScreen_processBox_text}>
						W naszym sklepie WickerLand specjalizujemy się w sprzedaży
						produktów zrobionych z wikliny. Materiał, z którego wytwarzamy nasze
						produkty, pochodzi z polskich plantacji wierzby, gdzie rośnie ona w
						naturalnym środowisku. Kiedy nadchodzi czas zbioru, do pracy
						zabierają się wykwalifikowani pracownicy, którzy wycinają gałęzie
						zgodnie z zasadami dbałości o środowisko. Następnie, w procesie
						suszenia, gałęzie stają się gotowe do dalszej obróbki.
					</p>
				</div>
			</div>
			<div className={styles.aboutUsScreen_processBox}>
